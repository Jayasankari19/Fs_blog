...
//       // Assuming the response contains the new post object
//       addPost(response.data);  // Add the new post to the state in the parent component
//       navigate("/");  // Redirect to the homepage after creating a post
//     } catch (error) {
...
//         <textarea value={title3} onChange={(e) => setTitle3(e.target.value)} className="p-3 border border-gray-300 rounded-md w-full h-30" placeholder="Blog content" />
